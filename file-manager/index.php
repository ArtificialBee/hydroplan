...
$hydroplan_path = 'hydroplan/file-manager/hydroplan-folder';

// Root path for file manager
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'] . '/' . $hydroplan_path;
                                    ...
                                    <div class="form-group">
                                       <div class="brand">
                                        ...
                                        <div class="text-center">
                                            <h1 class="card-title">Hydroplan File Manager</h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
...
define('FM_UPLOADONLY', $use_auth && !empty($upload_users) && isset($_SESSION[FM_SESSION_ID]['logged']) && in_array($_SESSION[FM_SESSION_ID]['logged'], $upload_users));
...
// Upload
if (!empty($_FILES) && (!FM_READONLY || FM_UPLOADONLY)) {
...
// upload form
if (isset($_GET['upload']) && (!FM_READONLY || FM_UPLOADONLY)) {
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <?php if (!FM_READONLY || FM_UPLOADONLY): ?>
                    <li class="nav-item">
